...
public class Robot extends TimedRobot {
  ...
  PWMVictorSPX leftTalon = new PWMVictorSPX(RobotMap.leftTalonChannle);
  MotorControllerGroup m_left = new MotorControllerGroup(frontLeft, middleLeft, backLeft, leftTalon);

// The Arm Motor Declaration
...
// Arm Down is Interted
// second_controller.getRawButton(5)
    if (second_controller.getRawAxis(1) == 1) {
